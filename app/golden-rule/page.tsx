...
export const metadata: Metadata = {
  title: "Golden Rules",
  description: "Cache revalidation golden rules",
};
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-violet-950 border border-violet-700 rounded-xl p-5">
              ...
              <p className="text-sm text-zinc-400 mt-2">
                Busts the rendered HTML of the page
              </p>
            </div>
...
export async function getData() {
  return getCached();
            ...
            <div className="bg-zinc-900 border border-emerald-700 rounded-xl p-5">
              <p className="text-xs text-emerald-400 uppercase tracking-widest mb-4">
                ✅ Next.js 16 — New
              </p>
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-5">
            <div className="bg-zinc-900 border border-emerald-700 rounded-xl p-5">
              ...
              <p className="text-base font-bold text-emerald-300 mb-2">
                updateTag("key")
              </p>
            ...
            <div className="bg-zinc-900 border border-amber-700 rounded-xl p-5">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                ...
                . Serves old data once, refreshes in background.
              </p>
              <p className="text-xs text-zinc-600 border-t border-zinc-800 mt-4 pt-3">
  ...
  redirect("/contacts"); // ✅ OUTSIDE try-catch — redirect throws internally
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              {
                key: "redirect()",
                value: "must be OUTSIDE try-catch — it throws internally",
                color: "text-red-400",
              },
              {
                key: "updateTag()",
                value: "works in Server Actions ONLY — not Route Handlers",
                color: "text-emerald-400",
              },
              {
                key: "revalidateTag()",
                value: "works in Server Actions AND Route Handlers",
                color: "text-cyan-400",
              },
              {
                key: '"use cache"',
                value: "requires cacheComponents: true in next.config.ts",
                color: "text-violet-400",
              },
              {
                key: "Never",
                value: "call revalidatePath / updateTag inside READ functions",
                color: "text-red-400",
              },
              {
                key: "Always",
                value:
                  "bust ALL affected tags when multiple caches are impacted",
              ...
              >
                <span className={`font-bold text-sm shrink-0 w-32 ${color}`}>
                  {key}
                </span>
        ...
        <div className="border-t border-zinc-800 mt-10 pt-5 text-center">
          <p className="text-xs text-zinc-600 tracking-wide">
            Next.js 16 · Cache Components · "use cache" · cacheTag · updateTag ·
